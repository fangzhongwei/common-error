...
public enum ErrorCode {
    ...
    EC_UC_PROFILE_UN_MATCHED("EC_UC_PROFILE_UN_MATCHED", "用户资料验证未通过。"),
    ...
    EC_SMS_DAY_LIMIT_ERROR("EC_SMS_DAY_LIMIT_ERROR", "手机号当天获取验证码次数超过系统限制。"),
    ...
    MSG_VC_VOUCHER_NOT_EXISTS("MSG_VC_VOUCHER_NOT_EXISTS", "没有找到凭证。"),

    EC_CAP_CAPTCHA_EXPIRED("EC_CAP_CAPTCHA_EXPIRED", "验证码已过期。"),
    EC_CAP_INVALID_CAPTCHA("EC_CAP_INVALID_CAPTCHA", "验证码不正确。"),

    EC_BUS_BANK_CARD_NOT_FOUND("EC_BUS_BANK_CARD_NOT_FOUND", "银行卡未找到。"),
    EC_BUS_ACCOUNT_NOT_FOUND("EC_BUS_ACCOUNT_NOT_FOUND", "账户未找到。"),

    EC_BUS_ACCOUNT_FREEZE_IN("EC_BUS_ACCOUNT_FREEZE_IN", "抱歉，您的账户已冻结充值功能。"),
    EC_BUS_ACCOUNT_FREEZE_OUT("EC_BUS_ACCOUNT_FREEZE_OUT", "抱歉，您的账户已冻结提现功能。"),

    EC_BUS_DEPOSIT_ORDER_NOT_FOUND("EC_BUS_DEPOSIT_ORDER_NOT_FOUND", "充值订单未找到。"),
    EC_BUS_WITHDRAW_ORDER_NOT_FOUND("EC_BUS_WITHDRAW_ORDER_NOT_FOUND", "提现订单未找到。"),
    EC_BUS_ORDER_HANDED("EC_BUS_ORDER_HANDED", "订单已处理。"),
    EC_BUS_ORDER_STATUS_NOT_WAITING_HANDLE("EC_BUS_ORDER_STATUS_NOT_WAITING_HANDLE", "订单状态不是待处理。"),
    EC_BUS_ORDER_STATUS_NOT_WAITING_DEPOSIT("EC_BUS_ORDER_STATUS_NOT_WAITING_DEPOSIT", "充值时间已经提交。"),
    EC_BUS_DEPOSIT_BANK_WATER_USED("EC_BUS_DEPOSIT_BANK_WATER_USED", "银行流水号已经入款！"),
    EC_BUS_WITHDRAW_BANK_WATER_USED("EC_BUS_WITHDRAW_BANK_WATER_USED", "银行流水号已经出款！"),

    EC_BUS_NOT_ENOUGH_MAY_WITHDRAW_AMOUNT("EC_BUS_NOT_ENOUGH_MAY_WITHDRAW_AMOUNT", "可提现余额不足！"),
    EC_BUS_WITHDRAW_ORDER_STATUS_NOT_WAITING_HANDLE("EC_BUS_WITHDRAW_ORDER_STATUS_NOT_WAITING_HANDLE", "提现订单状态不是待处理状态。"),
